...
EvalCore.gatherContext = function (env, trip) {
  // Gather core values
  var context = _.assign({}, trip.values, {
    currentSceneName: trip.currentSceneName,
    schedule: trip.schedule,
    history: trip.history
  });
  // Add waypoint values if present
  var waypointNames = Object.keys(trip.values.waypoint_options || {});
  _.each(waypointNames, function(waypointName) {
    ...
    var optionName = trip.values.waypoint_options[waypointName];
