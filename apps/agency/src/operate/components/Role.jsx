  ...
  const interfaceTab = user ? (
    <li className="nav-item">
      <Link
        ...
        to={`/operate/${params.groupId}/all/role/${params.roleName}/${params.userId}/interface`}>
        Interface
      </Link>
    </li>
  ) : null;
      ...
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <IndexLink
            className="nav-link"
            activeClassName="active"
            to={`/operate/${params.groupId}/all/role/${params.roleName}/${params.userId}`}>
        ...
        <li className="nav-item">
          <Link
            className="nav-link"
            activeClassName="active"
            to={`/operate/${params.groupId}/all/role/${params.roleName}/${params.userId}/messages`}>
            Messages
          </Link>
        </li>
        {interfaceTab}
