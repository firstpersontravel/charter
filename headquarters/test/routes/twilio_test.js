...
describe('twilioRoutes', () => {
  ...
  beforeEach(async () => {
    ...
    travelerRelay = await models.Relay.create({
      ...
      forPhoneNumber: travelerParticipant.phoneNumber,
      forRoleName: 'Player',
      asRoleName: 'Player',
      withRoleName: 'Actor',
    ...
    await models.Relay.create({
      ...
      stage: 'test',
      lastActiveAt: mockNow,
      forPhoneNumber: actorParticipant.phoneNumber,
      forRoleName: 'Actor',
      asRoleName: 'Actor',
      withRoleName: 'Player',
  ...
  describe('#incomingMessageRoute', () => {
    it('handles incoming text', async () => {
      ...
      const req = httpMocks.createRequest({
        body: {
          SmsStatus: 'incoming',
          From: travelerParticipant.phoneNumber, // participant
          To: travelerRelay.relayPhoneNumber,   // relay
          Body: 'Reply',
          NumMedia: '0'
        }
      });
    ...
    it('handles outgoing call to start conference', async () => {
      ...
      const req = httpMocks.createRequest({
        ...
        body: {
          ...
          From: travelerRelay.relayPhoneNumber,  // Player relay
          To: travelerParticipant.phoneNumber    // Player participant
        }
      });
      const res = httpMocks.createResponse();
