 ...
 */
RelaysController.purchaseNumber = async () => {
 ...
 */
RelaysController.assignRelayPhoneNumber = async (userPhoneNumber) => {
 ...
 */
RelaysController.ensureRelay = async (
  scriptName, departureName, relaySpec, userPhoneNumber
) => {
  ...
  const relayPhoneNumber = await (
    RelaysController.assignRelayPhoneNumber(userPhoneNumber)
  );
 ...
 */
RelaysController.ensureTrailheadsForScriptName = async (scriptName) => {
...
RelaysController.findByNumber = async (relayNumber, userNumber) => {
